...
const ModifyPlan: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    formData.append('file', pdfFile); // Name must match your backend field
    ...
    try {
      const response = await apiService.plans.submitMealPlan(formData);
      ...
      <div className="flex flex-col h-full px-4 py-6">
        ...
        <div className="relative flex mb-6 flex-shrink-0 bg-transparent border border-gray-400 rounded-2xl">
          ...
          <button
            ...
            className={`relative z-10 flex-1 py-6 px-1 text-center font-bold transition-colors duration-300 rounded-md ${activeToggle === 'videos'
              ? 'text-white'
              : 'text-gray-700'
              }`}
          >
          ...
          <button
            ...
            className={`relative z-10 flex-1 py-6 px-1 text-center font-bold transition-colors duration-300 rounded-md ${activeToggle === 'meal'
              ? 'text-white'
              : 'text-gray-700'
              }`}
          >
          ...
          <div className="fixed inset-0 z-50 flex items-end justify-center">
            ...
            <div className="relative bg-white w-full max-w-md rounded-t-3xl animate-slide-up-enter overflow-hidden">
              ...
              <div className="p-6 flex flex-col gap-6">
                {/* Upload PDF */}
                <label className="border border-gray-300 rounded-xl flex flex-col items-center justify-center py-8 cursor-pointer">
                  <input
                    type="file"
                    accept=".pdf"
                    onChange={(e) => {
                ...
                <button onClick={handleSubmit}
                  className={`w-full py-3 rounded-lg font-bold text-center ${activeButton === true ? "bg-black" : "bg-gray-400"} text-white ddc-hardware`}
