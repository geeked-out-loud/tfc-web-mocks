      ...
      <div className="relative h-[50vh] lg:h-full lg:w-1/2">
        ...
        <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-black via-black/70 to-transparent flex flex-col justify-end lg:justify-center p-6 lg:p-12">
          <div className="text-white lg:max-w-md">
            ...
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold ddc-hardware mb-4 lg:mb-6">
              {isLogin ? "TRAINER LOGIN" : "TRAINER SIGNUP"}
            </h2>
            <p className="hidden lg:block text-lg text-gray-200 poppins-regular">
              Join our community of expert trainers and transform lives through fitness.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6 py-12 lg:py-0 w-full">
            ...
            <>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 py-3 border border-gray-300 rounded-full hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="text-center mt-6">
              {isLogin ? (
                ...
                <p className="text-gray-500 text-sm">
                  By signing up, you agree to our <br className="lg:hidden" /> 
                  <a href="#" className="text-[#262012] font-bold hover:underline">Terms of Service</a> and <a href="#" className="text-[#262012] font-bold hover:underline">Privacy Policy</a>
                </p>
              )}
            </div>
            ...
            <div className="hidden lg:block text-center pt-8 border-t border-gray-200 mt-8">
              <p className="text-xs text-gray-400">
                © 2024 The Fit Collective. All rights reserved.
              </p>
            </div>
          </div>
        </div>
